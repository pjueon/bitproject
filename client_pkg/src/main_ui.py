...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Form.resize(1855, 1025)
        self.Form.setMinimumSize(QtCore.QSize(1855, 1025))
        self.Form.setMaximumSize(QtCore.QSize(1855, 1025))
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.Form)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 1850, 1020))
        ...
        self.Map_View.setMinimumSize(QtCore.QSize(952, 952))
        self.Map_View.setMaximumSize(QtCore.QSize(952, 952))
        self.Map_View.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.listwidget.setMinimumSize(QtCore.QSize(875, 170))
        self.listwidget.setMaximumSize(QtCore.QSize(875, 170))
        self.button_Grid.addWidget(self.listwidget, 5, 0, -1, -1)

        self.Camera_View = QtWidgets.QGraphicsView(self.horizontalLayoutWidget)
        self.Camera_View.setMinimumSize(QtCore.QSize(875, 635))
        self.Camera_View.setMaximumSize(QtCore.QSize(875, 635))
